...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/PROGETTO_TSW/Registration/icone/Logo_40x40.ico">
    <script src="/PROGETTO_TSW/Registration/scriptReg.js" type="text/javascript"></script>
</head>
<body>
    <?php include_once $_SERVER['DOCUMENT_ROOT'] . '/PROGETTO_TSW/Registration/headerReg.php'; ?>
...
<?php
     ...
     include_once $_SERVER['DOCUMENT_ROOT'] . '/PROGETTO_TSW/Registration/db.php';
